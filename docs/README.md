...
# impresee-script-integration-app
...
This app is used for integrating Impresee's integration script into a VTEX store.
...
3. You'll see a warning message about needing to enter the necessary configurations. Scroll down and type in your **Impresee script name** in the `Impresee Script Integration App` field.
4. Click on **Save**.
...
3. Fill in the `Impresee Script Integration App` field with your **Impresee script name**.
4. Click on **Save**.
...
- [Camila Álvarez](https://github.com/CamilaAlvarez)
