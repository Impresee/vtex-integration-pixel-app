...
3. You'll see a warning message about needing to enter the necessary configurations. Scroll down and type in your **Impresee script URL** in the `Impresee Script Integration App` field.
4. Click on **Save**.
...
3. Fill in the `Impresee Script Integration App` field with your **Impresee script URL**.
4. Click on **Save**.
